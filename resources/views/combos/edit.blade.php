...
@section('content')
    <div class="max-w-5xl mx-auto p-6 bg-white shadow-md rounded-lg">
        <h1 class="text-2xl font-bold text-center mb-8">Chỉnh Sửa Combo</h1>
                ...
                <div>
                    ...
                    <div class="bg-gray-100 rounded-lg flex items-center">
                        ...
                        <input type="number" id="price" name="price" min="1000" step="100"
                            ...
                            class="bg-transparent w-full py-3 px-4 text-left outline-none" placeholder="Nhập giá combo">
                    </div>
                </div>
                    ...
                    <div class="max-w-md mx-auto p-6 bg-white shadow-md rounded-lg my-8">
                        <div class="flex flex-col items-center">
                            ...
                            <div
                                ...
                                <img id="imagePreview"
                                    src="{{ $combo->image ? $combo->image : 'https://res.cloudinary.com/dswj1rtvu/image/upload/v1745050814/BookStore/Books/no_cover_available_bjb33v.png' }}"
            ...
            <div class="mt-6">
                ...
                <div class="bg-gray-100 rounded-lg flex items-start">
                    ...
                    <textarea id="description" name="description" rows="4"
                        class="bg-transparent w-full py-3 px-4 text-left outline-none resize-none" placeholder="Nhập mô tả về combo">{{ old('description', $combo->description) }}</textarea>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let selectedBooks = @json($combo->books->pluck('price', 'id')->toArray());
